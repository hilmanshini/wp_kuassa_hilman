...
// tool for media_queries
wp_enqueue_style('visual-media-queries', get_stylesheet_directory_uri().'/css/visual-media-queries.css', false, true);
wp_enqueue_script('visual_browser', get_template_directory_uri() . '/js/visual-browser-size.js', array('jquery'), false , true);
wp_enqueue_script('visual_media', get_template_directory_uri() . '/js/visual-media-queries.js', array('jquery'), false , true);
...
<div id="main_template" class="layout_boxed clearfix line">
    ...
    <div id="wrapper" class="clearfix">
>>>>>>> 7421c1c1d0c7f190025f677448db1c87ffebf09a
    <?php responsive_in_wrapper(); // wrapper hook ?>